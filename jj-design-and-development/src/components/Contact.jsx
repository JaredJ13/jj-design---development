      ...
      <Container>
        <InnerContainer>
          <CustomTransition type="fade">
            <H2TitleContainer>
              <H2 id="contact" margin="8rem 0 0 0">
                Get In Touch
              </H2>
            </H2TitleContainer>
          </CustomTransition>
              ...
              <FlexContactExtend>
                <div className="left-side">
                  <p className="paragraph">
                    To reach out about work, business, or anything in the tech
                    field, send me a message using the form. I’m always happy to
                    chat tech!
                  </p>

                  <div className="contact-icons">
                    <a href="https://www.linkedin.com/in/jared-jahnke-672b8317a/">
                      <LinkedInIcon
                        className="linkedin-icon"
                        fontSize="large"
                      />
                    </a>
                    <a href="https://github.com/JaredJ13">
                ...
                <div className="right-side">
                  <form ref={form} onSubmit={(e) => sendEmail(e)}>
                    ...
                    {emailSuccess !== "" && emailSuccess !== null ? (
                      <p className="email-success-message">{emailSuccess}</p>
                    ) : (
                      ""
                    )}
