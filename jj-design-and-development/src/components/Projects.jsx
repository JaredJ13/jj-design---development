                            ...
                            <Card>
                                <FlexProjectsExtend>
                                    <div className="left-side">
                                        <a href="https://pointtracker.netlify.app/"><img src={PointTrackerProject} alt="point tracker app website overview" /></a>
                                    </div>
                                    <div className="mini-div"></div>
                                    <div className="right-side">
                                        <H3ProjectsExtend margin='1.5rem 0 1rem 0' fontWeight='500'><a href="https://pointtracker.netlify.app/">Nerts Score Tracker Web App <ArrowCircleRightIcon fontSize="medium" /></a></H3ProjectsExtend>
                        ...
                        <Grid item xs={12}>
                            <Card>
                                <FlexProjectsExtend>
                                    ...
                                    <div className="mini-div"></div>
                                    <div className="right-side">
                                        <H3ProjectsExtend margin='1.5rem 0 1rem 0' fontWeight='500'><a href="https://hazzardcountybarandgrill.ca">Responsive Restaurant Web App <ArrowCircleRightIcon fontSize="medium" /></a></H3ProjectsExtend>
                                        <div className="right-p-container">
                                            <p>
